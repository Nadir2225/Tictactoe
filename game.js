...
const check = (id) =>{
  ...
  if (turn == "ofx"){
      ...
      pl2.style.border = "2px solid #ff352b"
      id.value = true
      id.type = "x"
      turn = "ofo"
      winner()
         ...
         i++
         pl1.style.border = "2px solid #18ffff"
...
const stylecolor = (n1,color) => {
    n1.style.width = "82px"
    n1.style.height = "82px"
    n1.style.backgroundColor = `${color}`
    n1.style.boxShadow = `0 0 12px ${color}`
}
...
const resume = () => {
    ...
    array.map(x => {
        ...
        x.style.boxShadow = "0 0 8px grey"
        }else{
        x.style.backgroundColor = "#323232" 
        x.style.boxShadow = "0 0 12px #323232" 
        }
        x.innerHTML = "<img>"
    })
    pl1.style.border = "2px solid #18ffff"
